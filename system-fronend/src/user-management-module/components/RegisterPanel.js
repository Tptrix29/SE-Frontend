            ...
            <div className="page-panel">
                <div className="page-info-center">
                    ...
                    <InputGroup className="mb-3">
                        ...
                        <Form.Control placeholder="请输入" required onChange={this.updateUsername} isValid={this.state.isUsernameValid}/>
                    </InputGroup>
                    <InputGroup className="mb-3">
                        请输入邮箱
                    </InputGroup>
                    <InputGroup className="mb-3">
                        ...
                        <Form.Control placeholder="请输入" required  onChange={this.updateEmail} isValid={this.state.isEmailValid}/>
                    </InputGroup>
                    <InputGroup className="mb-3">
                    ...
                    <InputGroup className="mb-3">
                        ...
                        <Form.Control placeholder="请输入密码" type='password' required onChange={this.updatePassword1} isValid={this.state.isPwdValid}/>
                    </InputGroup>
                    <InputGroup className="mb-3">
                        请再次输入密码
                    </InputGroup>
                    <InputGroup className="mb-3">
                        ...
                        <Form.Control placeholder="请确认密码" type='password' required onChange={this.updatePassword2} isValid={this.state.isSamePwd} />
                    </InputGroup>
